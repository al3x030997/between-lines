...
export const EXAMPLE_BOOK_LIBRARY: ExampleBookMetadata[] = [
  {
    ...
    cover: cover('the-quiet-hours-genre-v2', 1024, 1536),
    badges: [
  ...
  },
  {
    ...
    cover: cover('three-tuesdays-in-november-genre-v2', 1024, 1536),
  ...
  },
  {
    ...
    cover: cover('the-glass-meridian-genre-v2', 1024, 1536),
    badges: [{ kind: 'bl', label: 'BetweenLines Pick' }],
  ...
  },
  {
    ...
    cover: cover('ember-and-the-cartographer-genre-v2', 1024, 1536),
  ...
  },
  {
    ...
    cover: cover('salt-and-the-sea-between-genre-v2', 1024, 1536),
  ...
  },
  {
    ...
    cover: cover('before-the-frost-genre-v2', 1024, 1536),
  ...
  },
  {
    ...
    cover: cover('the-empty-chair-genre-v2', 1024, 1536),
    badges: [{ kind: 'rp', label: 'Reader Pick' }],
  ...
  },
  {
    ...
    cover: cover('the-margin-notes-genre-v2', 1024, 1536),
    badges: [{ kind: 'bl', label: 'BetweenLines Pick' }],
  ...
  },
  {
    ...
    cover: cover('ink-and-wander-genre-v2', 1024, 1536),
    badges: [{ kind: 'rp', label: 'Reader Pick' }],
  ...
  },
  {
    ...
    category: 'Literary Fiction - Novel',
    cover: cover('the-archivist-of-small-things-genre-v2', 1024, 1536),
    badges: [{ kind: 'bp', label: 'Beta Pick' }],
  ...
  },
  {
    ...
    cover: cover('what-the-river-keeps-genre-v2', 1024, 1536),
    badges: [],
  ...
  },
  {
    ...
    cover: cover('the-count-of-monte-cristo-genre-v2', 1024, 1536),
    badges: [
  ...
  },
  {
    ...
    cover: cover('the-lantern-orchard-genre-v2', 1024, 1536),
    badges: [{ kind: 'bl', label: 'BetweenLines Pick' }],
  ...
  },
  {
    ...
    cover: cover('a-map-of-quiet-rooms-genre-v2', 1024, 1536),
    badges: [{ kind: 'bp', label: 'Beta Pick' }],
  ...
  },
  {
    ...
    author: 'Naomi Calder',
    category: 'Literary Fiction - Novel',
    cover: cover('weather-for-borrowed-houses-genre-v2', 1024, 1536),
    badges: [{ kind: 'rp', label: 'Reader Pick' }],
  ...
  },
  {
    ...
    cover: cover('the-ninth-harbor-genre-v2', 1024, 1536),
    badges: [{ kind: 'mp', label: 'Member Pick' }],
  ...
  },
  {
    ...
    author: 'Lena Park',
    category: 'Short Story Collection',
    cover: cover('small-fires-soft-rain-genre-v2', 1024, 1536),
    badges: [{ kind: 'bl', label: 'BetweenLines Pick' }],
  ...
  },
  {
    ...
    cover: cover('the-museum-of-last-requests-genre-v2', 1024, 1536),
    badges: [{ kind: 'bp', label: 'Beta Pick' }],
  ...
  },
  {
    ...
    cover: cover('red-thread-under-snow-genre-v2', 1024, 1536),
    badges: [{ kind: 'mp', label: 'Member Pick' }],
  ...
  },
  {
    ...
    cover: cover('the-choir-at-the-end-of-august-genre-v2', 1024, 1536),
    badges: [{ kind: 'rp', label: 'Reader Pick' }],
  ...
  },
  {
    ...
    cover: cover('where-the-blue-letters-go-genre-v2', 1024, 1536),
    badges: [{ kind: 'bl', label: 'BetweenLines Pick' }],
  ...
  },
  {
    ...
    cover: cover('the-clockmakers-daughter-genre-v2', 1024, 1536),
    badges: [{ kind: 'bp', label: 'Beta Pick' }],
