 ...
 * whenever there is no active session, so logged-out visitors see the gallery in
 * the bright paper/ink/yellow landing aesthetic. Logged-in readers keep the dark
 * cinematic gallery. Runs as a client
