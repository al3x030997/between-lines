export function StoreHero() {
  return (
    <section className="br-store-hero" aria-label="Store hero">
      ...
      <p className="br-store-hero-sub">Ebooks · Audiobooks · BetweenLines · Reading Credits · Merch</p>
      <div className="br-member-nudge">
        <span className="br-member-nudge-text">
          ✦ Members get <strong>20% off everything</strong> in the store + 100 Reading Credits welcome bonus.
        </span>
