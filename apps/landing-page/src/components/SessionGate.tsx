...
// The logged-out writer Studio at /write: the real Studio reused as a public,
// sign-up-nudged guest route, plus the one book a guest may open as a sample.
// (The logged-out /read page is a standalone marketing page outside the (reader)
// group, so it isn't gated here at all.) Exact-match only — deeper reader routes
// like /read/<book> otherwise stay gated.
