...
// The one book a guest may open as a sample. (The logged-out /read and /write
// pages are standalone marketing pages outside the (reader) group, so they
// aren't gated here at all.) Exact-match only — deeper reader routes like
// /read/<book> otherwise stay gated.
const PUBLIC_EXACT = ['/read/small-fires-soft-rain'];
