        ...
        <EmptyState
          ...
          action={
            <div className="flex justify-center gap-2">
              <Link
                href="/"
                className="px-3 py-1.5 rounded-md text-sm bg-accent text-zinc-900 hover:bg-accent-hover"
              >
                Import spreadsheet
              </Link>
              <Link
      ...
      <Cell padded>
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-2 py-0.5 rounded text-[11px] bg-accent text-zinc-900 hover:bg-accent-hover disabled:opacity-40"
          >
            Add
          </button>
          <button
